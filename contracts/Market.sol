...
contract MarketFactory is Ownable, ReentrancyGuard {
    ...
    event FundsWithdrawn(address indexed recipient, uint256 amount, address indexed admin);
 ...
    */
    function removeMarket(uint256 marketId) external onlyAdmin{
 ...
    */
    ...
    /**
    * @notice Allows admins to withdraw all funds from the contract
